...
export async function up(knex) {
    ...
    // CORREÇÃO: Ignora pedidos Cancelados e removidos (soft delete)
    // ==========================================
    await knex.raw(`
    ...
    // CORREÇÃO: Ignora removidos (soft delete)
    // ==========================================
    await knex.raw(`
...
export async function down(knex) {
    // ==========================================
    // DOWN: Restaura as funções para o estado ANTERIOR com os bugs 
    // para caso o comando de rollback seja executado no servidor.
    // ==========================================
